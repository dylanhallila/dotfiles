...
ssh-port-forward() {
	...
	ssh -L "$1:localhost:$1" -N dylanh@dylanh.rtvision.com
}
...
# ssh aliases
alias ssh-vm='ssh -A dylanh@2620:9d:4000:72:136c:fa8:54b:9be1'
alias ssh-ws='ssh dylanh@dylanh.rtvision.com'
...
# pnpm
export PNPM_HOME="/home/dylanh/.local/share/pnpm"
case ":$PATH:" in
*":$PNPM_HOME:"*) ;;
